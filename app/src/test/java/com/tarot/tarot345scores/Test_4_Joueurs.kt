...
class Test_4_Joueurs {
    ...
    fun FFT_01() {
        ...
        val expected = listOf(318, -106, -106, -106)
    ...
    fun FFT_02() {
        ...
        val expected = listOf(228, -76, -76, -76)
        assertEquals(expected, result)
    }
    ...
    fun FFT_03() {
        ...
        val expected = listOf(-126, 42, 42, 42)
        assertEquals(expected, result)
    }
    ...
    fun FFT_04() {
        ...
        val expected = listOf(276, -92, -92, -92)
        assertEquals(expected, result)
    }
    ...
    fun FFT_05() {
        ...
        val expected = listOf(1746, -582, -582, -582)
        assertEquals(expected, result)
    }
    ...
    fun perso_01() {
        ...
        val expected = listOf(1740, -580, -580, -580) //OK
        assertEquals(expected, result)
    }
    ...
    fun perso_02() {
        ...
        val expected = listOf(108, -36, -36, -36) //OK
        assertEquals(expected, result)
    }
    ...
    fun perso_03() {
        ...
        val expected = listOf(262,-74, -74, -114) //OK
        assertEquals(expected, result)
    }
    ...
    fun perso_04() {
        ...
        val expected = listOf(-260, 100, 100, 60) //OK
        assertEquals(expected, result)
    }
}
